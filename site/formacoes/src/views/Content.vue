<template>
  <div class="table-wrapper">
    <table>
          ...
          <div>
            ...
            <div>
              <img
                ...
                v-on:click="orderTable('date-asc')"
              />
              <img
                src="../assets/chevron_down.png"
                v-on:click="orderTable('date-desc')"
              />
            </div>
          </div>
        </th>
        <th class="column-small">
          <div>
            ...
            <div>
              <img
                src="../assets/chevron_up.png"
                v-on:click="orderTable('subs-asc')"
              />
              <img
                src="../assets/chevron_down.png"
                v-on:click="orderTable('subs-desc')"
              />
            </div>
          </div>
        </th>
        <th class="column-small">
          <div>
            ...
            <div>
              <img
                src="../assets/chevron_up.png"
                v-on:click="orderTable('nvids-asc')"
              />
              <img
                src="../assets/chevron_down.png"
                v-on:click="orderTable('nvids-desc')"
              />
            </div>
          </div>
        </th>
        <th class="column-small">
          <div>
            ...
            <div>
              <img
                src="../assets/chevron_up.png"
                v-on:click="orderTable('duration-asc')"
              />
              <img
                src="../assets/chevron_down.png"
                v-on:click="orderTable('duration-desc')"
              />
            </div>
          </div>
        </th>
      ...
      <tbody>
        <ContentTableRow
          v-for="course in this.displayCourses"
          :key="course.id"
    ...
    <Pagination2
      v-bind:totalItems="this.courses.length"
      v-bind:currentPage="this.currentPage"
      v-bind:itemsPerPage="this.itemsPerPage"
  ...
  methods: {
    orderTable(order) {
      switch (order) {
        ...
        case "nvids-asc":
          this.courses.sort((a, b) =>
            a.numberOfVideos > b.numberOfVideos
              ? 1
              : b.numberOfVideos > a.numberOfVideos
              ? -1
              : 0
          );
          break;
        ...
        case "duration-asc":
          this.courses.sort((a, b) =>
            parseInt(a.duration.replaceAll(":", "")) >
            parseInt(b.duration.replaceAll(":", ""))
              ? 1
              : parseInt(b.duration.replaceAll(":", "")) >
                parseInt(a.duration.replaceAll(":", ""))
              ? -1
      ...
      this.displayCourses = this.courses.slice(
