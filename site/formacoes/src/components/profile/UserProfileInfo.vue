<template>
  <div
    ...
    :class="{ 'edit-mode': this.editMode }"
  >
    <div>
      <img class="profile-image" :src="this.imageUrl" />
      <div
        ref="profileInfoArea"
        class="profile-info-area"
        :class="{ 'd-none': this.editMode }"
      >
      ...
      <div
        ref="profileEditingArea"
        class="profile-edit-area"
        :class="{ 'd-none': !this.editMode }"
      >
        <div>
          <div>
